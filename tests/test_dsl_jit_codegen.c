...
static int test_codegen_runtime_math_bridge_vector_lowering_binary_minmax_broadcast(void) {
    printf("\n=== JIT C Codegen Test 10: runtime math bridge vector binary min/max broadcast lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_lowering_binary_pow_broadcast(void) {
    printf("\n=== JIT C Codegen Test 11: runtime math bridge vector binary pow broadcast lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_lowering_unary_affine(void) {
    printf("\n=== JIT C Codegen Test 12: runtime math bridge unary affine lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_lowering_unary_extra(void) {
    printf("\n=== JIT C Codegen Test 13: runtime math bridge unary extra lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_lowering_unary_extended(void) {
    printf("\n=== JIT C Codegen Test 14: runtime math bridge unary extended lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_lowering_assign_return(void) {
    printf("\n=== JIT C Codegen Test 15: runtime math bridge assign+return lowering ===\n");
...
static int test_codegen_runtime_math_bridge_vector_gate_disable(void) {
    ...
    options.use_runtime_math_bridge = true;
    options.has_enable_vector_math = true;
    options.enable_vector_math = false;
    options.trace_lowering_mode = lowering_mode;
    options.trace_lowering_mode_cap = sizeof(lowering_mode);
    options.trace_lowering_reason = lowering_reason;
    options.trace_lowering_reason_cap = sizeof(lowering_reason);
...
int main(void) {
    ...
    fail |= test_codegen_runtime_math_bridge_vector_lowering_binary_minmax_broadcast();
