...
static const me_variable functions[] = {
    ...
    {"arccos", 0, acos, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"arccosh", 0, acosh, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"arcsin", 0, asin, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"arcsinh", 0, asinh, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"arctan", 0, atan, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"arctan2", 0, atan2, ME_FUNCTION2 | ME_FLAG_PURE, 0},
    {"arctanh", 0, atanh, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"asin", 0, asin, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"asinh", 0, asinh, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    ...
    {"cos", 0, cos, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"cosh", 0, cosh, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"cospi", 0, cospi_wrapper, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"e", 0, e, ME_FUNCTION0 | ME_FLAG_PURE, 0},
    {"endswith", 0, str_endswith, ME_FUNCTION2 | ME_FLAG_PURE, 0},
    {"erf", 0, erf, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"erfc", 0, erfc, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
    {"exp", 0, exp, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
...
#ifdef ME_NAT_LOG
    {"log", 0, log, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
#else
    {"log", 0, log10, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
#endif
    {"log10", 0, log10, ME_FUNCTION1 | ME_FLAG_PURE | ME_FLAG_FLOAT_MATH, 0},
...
static me_expr* base(state* s) {
    ...
    if (IS_FUNCTION(s->type) || IS_CLOSURE(s->type)) {
        ...
        case ME_CLOSURE1:
            ...
            ret->function = s->function;
            if (s->type & ME_FLAG_FLOAT_MATH) {
                ret->flags |= ME_EXPR_FLAG_FLOAT_MATH;
            }
            if (func_dtype != ME_AUTO) {
                ret->dtype = func_dtype;
                ret->flags |= ME_EXPR_FLAG_EXPLICIT_DTYPE;
...
DEFINE_VEC_CONVERT(bool, c64, bool, float _Complex)
DEFINE_VEC_CONVERT(bool, c128, bool, double _Complex)
...
DEFINE_VEC_CONVERT(i8, u8, int8_t, uint8_t)
DEFINE_VEC_CONVERT(i8, u16, int8_t, uint16_t)
DEFINE_VEC_CONVERT(i8, u32, int8_t, uint32_t)
DEFINE_VEC_CONVERT(i8, u64, int8_t, uint64_t)
DEFINE_VEC_CONVERT(i8, f32, int8_t, float)
DEFINE_VEC_CONVERT(i8, f64, int8_t, double)
DEFINE_VEC_CONVERT(i8, c64, int8_t, float _Complex)
DEFINE_VEC_CONVERT(i8, c128, int8_t, double _Complex)

DEFINE_VEC_CONVERT(i16, i8, int16_t, int8_t)
DEFINE_VEC_CONVERT(i16, i32, int16_t, int32_t)
DEFINE_VEC_CONVERT(i16, i64, int16_t, int64_t)
DEFINE_VEC_CONVERT(i16, u8, int16_t, uint8_t)
DEFINE_VEC_CONVERT(i16, u16, int16_t, uint16_t)
DEFINE_VEC_CONVERT(i16, u32, int16_t, uint32_t)
DEFINE_VEC_CONVERT(i16, u64, int16_t, uint64_t)
DEFINE_VEC_CONVERT(i16, f32, int16_t, float)
DEFINE_VEC_CONVERT(i16, f64, int16_t, double)
DEFINE_VEC_CONVERT(i16, c64, int16_t, float _Complex)
DEFINE_VEC_CONVERT(i16, c128, int16_t, double _Complex)

DEFINE_VEC_CONVERT(i32, i8, int32_t, int8_t)
DEFINE_VEC_CONVERT(i32, i16, int32_t, int16_t)
DEFINE_VEC_CONVERT(i32, i64, int32_t, int64_t)
DEFINE_VEC_CONVERT(i32, u8, int32_t, uint8_t)
DEFINE_VEC_CONVERT(i32, u16, int32_t, uint16_t)
DEFINE_VEC_CONVERT(i32, u32, int32_t, uint32_t)
DEFINE_VEC_CONVERT(i32, u64, int32_t, uint64_t)
DEFINE_VEC_CONVERT(i32, f32, int32_t, float)
DEFINE_VEC_CONVERT(i32, f64, int32_t, double)
DEFINE_VEC_CONVERT(i32, c64, int32_t, float _Complex)
DEFINE_VEC_CONVERT(i32, c128, int32_t, double _Complex)

DEFINE_VEC_CONVERT(i64, i8, int64_t, int8_t)
DEFINE_VEC_CONVERT(i64, i16, int64_t, int16_t)
...
DEFINE_VEC_CONVERT(i64, u8, int64_t, uint8_t)
DEFINE_VEC_CONVERT(i64, u16, int64_t, uint16_t)
DEFINE_VEC_CONVERT(i64, u32, int64_t, uint32_t)
DEFINE_VEC_CONVERT(i64, u64, int64_t, uint64_t)
DEFINE_VEC_CONVERT(i64, c64, int64_t, float _Complex)
DEFINE_VEC_CONVERT(i64, c128, int64_t, double _Complex)

DEFINE_VEC_CONVERT(u8, i8, uint8_t, int8_t)
...
DEFINE_VEC_CONVERT(u8, c64, uint8_t, float _Complex)
DEFINE_VEC_CONVERT(u8, c128, uint8_t, double _Complex)

DEFINE_VEC_CONVERT(u16, i8, uint16_t, int8_t)
DEFINE_VEC_CONVERT(u16, i16, uint16_t, int16_t)
DEFINE_VEC_CONVERT(u16, u32, uint16_t, uint32_t)
DEFINE_VEC_CONVERT(u16, u64, uint16_t, uint64_t)
DEFINE_VEC_CONVERT(u16, u8, uint16_t, uint8_t)
...
DEFINE_VEC_CONVERT(u16, c64, uint16_t, float _Complex)
DEFINE_VEC_CONVERT(u16, c128, uint16_t, double _Complex)

DEFINE_VEC_CONVERT(u32, i8, uint32_t, int8_t)
DEFINE_VEC_CONVERT(u32, i16, uint32_t, int16_t)
DEFINE_VEC_CONVERT(u32, i32, uint32_t, int32_t)
DEFINE_VEC_CONVERT(u32, u64, uint32_t, uint64_t)
DEFINE_VEC_CONVERT(u32, u8, uint32_t, uint8_t)
DEFINE_VEC_CONVERT(u32, u16, uint32_t, uint16_t)
DEFINE_VEC_CONVERT(u32, i64, uint32_t, int64_t)
DEFINE_VEC_CONVERT(u32, f32, uint32_t, float)
DEFINE_VEC_CONVERT(u32, f64, uint32_t, double)
DEFINE_VEC_CONVERT(u32, c64, uint32_t, float _Complex)
DEFINE_VEC_CONVERT(u32, c128, uint32_t, double _Complex)

DEFINE_VEC_CONVERT(u64, i8, uint64_t, int8_t)
DEFINE_VEC_CONVERT(u64, i16, uint64_t, int16_t)
DEFINE_VEC_CONVERT(u64, i32, uint64_t, int32_t)
DEFINE_VEC_CONVERT(u64, i64, uint64_t, int64_t)
DEFINE_VEC_CONVERT(u64, u8, uint64_t, uint8_t)
DEFINE_VEC_CONVERT(u64, u16, uint64_t, uint16_t)
DEFINE_VEC_CONVERT(u64, u32, uint64_t, uint32_t)
DEFINE_VEC_CONVERT(u64, f32, uint64_t, float)
DEFINE_VEC_CONVERT(u64, f64, uint64_t, double)
DEFINE_VEC_CONVERT(u64, c64, uint64_t, float _Complex)
DEFINE_VEC_CONVERT(u64, c128, uint64_t, double _Complex)

DEFINE_VEC_CONVERT(f32, f64, float, double)
DEFINE_VEC_CONVERT(f32, i8, float, int8_t)
DEFINE_VEC_CONVERT(f32, i16, float, int16_t)
DEFINE_VEC_CONVERT(f32, i32, float, int32_t)
DEFINE_VEC_CONVERT(f32, i64, float, int64_t)
DEFINE_VEC_CONVERT(f32, u8, float, uint8_t)
DEFINE_VEC_CONVERT(f32, u16, float, uint16_t)
DEFINE_VEC_CONVERT(f32, u32, float, uint32_t)
DEFINE_VEC_CONVERT(f32, u64, float, uint64_t)
DEFINE_VEC_CONVERT(f32, c64, float, float _Complex)
DEFINE_VEC_CONVERT(f32, c128, float, double _Complex)

DEFINE_VEC_CONVERT(f64, i8, double, int8_t)
DEFINE_VEC_CONVERT(f64, i16, double, int16_t)
DEFINE_VEC_CONVERT(f64, i32, double, int32_t)
DEFINE_VEC_CONVERT(f64, i64, double, int64_t)
DEFINE_VEC_CONVERT(f64, u8, double, uint8_t)
DEFINE_VEC_CONVERT(f64, u16, double, uint16_t)
DEFINE_VEC_CONVERT(f64, u32, double, uint32_t)
DEFINE_VEC_CONVERT(f64, u64, double, uint64_t)
DEFINE_VEC_CONVERT(f64, c64, double, float _Complex)
...
#define CONV_CASE(FROM, TO, FROM_S, TO_S) \
    ...
    CONV_CASE(ME_BOOL, ME_COMPLEX64, bool, c64)
    CONV_CASE(ME_BOOL, ME_COMPLEX128, bool, c128)
    ...
    CONV_CASE(ME_INT8, ME_UINT8, i8, u8)
    CONV_CASE(ME_INT8, ME_UINT16, i8, u16)
    CONV_CASE(ME_INT8, ME_UINT32, i8, u32)
    CONV_CASE(ME_INT8, ME_UINT64, i8, u64)
    CONV_CASE(ME_INT8, ME_FLOAT32, i8, f32)
    CONV_CASE(ME_INT8, ME_FLOAT64, i8, f64)
    CONV_CASE(ME_INT8, ME_COMPLEX64, i8, c64)
    CONV_CASE(ME_INT8, ME_COMPLEX128, i8, c128)

    CONV_CASE(ME_INT16, ME_INT8, i16, i8)
    CONV_CASE(ME_INT16, ME_INT32, i16, i32)
    CONV_CASE(ME_INT16, ME_INT64, i16, i64)
    CONV_CASE(ME_INT16, ME_UINT8, i16, u8)
    CONV_CASE(ME_INT16, ME_UINT16, i16, u16)
    CONV_CASE(ME_INT16, ME_UINT32, i16, u32)
    CONV_CASE(ME_INT16, ME_UINT64, i16, u64)
    CONV_CASE(ME_INT16, ME_FLOAT32, i16, f32)
    CONV_CASE(ME_INT16, ME_FLOAT64, i16, f64)
    CONV_CASE(ME_INT16, ME_COMPLEX64, i16, c64)
    CONV_CASE(ME_INT16, ME_COMPLEX128, i16, c128)

    CONV_CASE(ME_INT32, ME_INT8, i32, i8)
    CONV_CASE(ME_INT32, ME_INT16, i32, i16)
    CONV_CASE(ME_INT32, ME_INT64, i32, i64)
    CONV_CASE(ME_INT32, ME_UINT8, i32, u8)
    CONV_CASE(ME_INT32, ME_UINT16, i32, u16)
    CONV_CASE(ME_INT32, ME_UINT32, i32, u32)
    CONV_CASE(ME_INT32, ME_UINT64, i32, u64)
    CONV_CASE(ME_INT32, ME_FLOAT32, i32, f32)
    CONV_CASE(ME_INT32, ME_FLOAT64, i32, f64)
    CONV_CASE(ME_INT32, ME_COMPLEX64, i32, c64)
    CONV_CASE(ME_INT32, ME_COMPLEX128, i32, c128)

    CONV_CASE(ME_INT64, ME_INT8, i64, i8)
    CONV_CASE(ME_INT64, ME_INT16, i64, i16)
    CONV_CASE(ME_INT64, ME_FLOAT32, i64, f32)
    CONV_CASE(ME_INT64, ME_FLOAT64, i64, f64)
    CONV_CASE(ME_INT64, ME_INT32, i64, i32)
    CONV_CASE(ME_INT64, ME_UINT8, i64, u8)
    CONV_CASE(ME_INT64, ME_UINT16, i64, u16)
    CONV_CASE(ME_INT64, ME_UINT32, i64, u32)
    CONV_CASE(ME_INT64, ME_UINT64, i64, u64)
    CONV_CASE(ME_INT64, ME_COMPLEX64, i64, c64)
    CONV_CASE(ME_INT64, ME_COMPLEX128, i64, c128)

    CONV_CASE(ME_UINT8, ME_INT8, u8, i8)
    ...
    CONV_CASE(ME_UINT8, ME_COMPLEX64, u8, c64)
    CONV_CASE(ME_UINT8, ME_COMPLEX128, u8, c128)

    CONV_CASE(ME_UINT16, ME_INT8, u16, i8)
    CONV_CASE(ME_UINT16, ME_INT16, u16, i16)
    CONV_CASE(ME_UINT16, ME_UINT32, u16, u32)
    CONV_CASE(ME_UINT16, ME_UINT64, u16, u64)
    CONV_CASE(ME_UINT16, ME_UINT8, u16, u8)
    ...
    CONV_CASE(ME_UINT16, ME_COMPLEX64, u16, c64)
    CONV_CASE(ME_UINT16, ME_COMPLEX128, u16, c128)

    CONV_CASE(ME_UINT32, ME_INT8, u32, i8)
    CONV_CASE(ME_UINT32, ME_INT16, u32, i16)
    CONV_CASE(ME_UINT32, ME_INT32, u32, i32)
    CONV_CASE(ME_UINT32, ME_UINT64, u32, u64)
    CONV_CASE(ME_UINT32, ME_UINT8, u32, u8)
    CONV_CASE(ME_UINT32, ME_UINT16, u32, u16)
    CONV_CASE(ME_UINT32, ME_INT64, u32, i64)
    CONV_CASE(ME_UINT32, ME_FLOAT32, u32, f32)
    CONV_CASE(ME_UINT32, ME_FLOAT64, u32, f64)
    CONV_CASE(ME_UINT32, ME_COMPLEX64, u32, c64)
    CONV_CASE(ME_UINT32, ME_COMPLEX128, u32, c128)

    CONV_CASE(ME_UINT64, ME_INT8, u64, i8)
    CONV_CASE(ME_UINT64, ME_INT16, u64, i16)
    CONV_CASE(ME_UINT64, ME_INT32, u64, i32)
    CONV_CASE(ME_UINT64, ME_INT64, u64, i64)
    CONV_CASE(ME_UINT64, ME_UINT8, u64, u8)
    CONV_CASE(ME_UINT64, ME_UINT16, u64, u16)
    CONV_CASE(ME_UINT64, ME_UINT32, u64, u32)
    CONV_CASE(ME_UINT64, ME_FLOAT32, u64, f32)
    CONV_CASE(ME_UINT64, ME_FLOAT64, u64, f64)
    CONV_CASE(ME_UINT64, ME_COMPLEX64, u64, c64)
    CONV_CASE(ME_UINT64, ME_COMPLEX128, u64, c128)

    CONV_CASE(ME_FLOAT32, ME_FLOAT64, f32, f64)
    CONV_CASE(ME_FLOAT32, ME_INT8, f32, i8)
    CONV_CASE(ME_FLOAT32, ME_INT16, f32, i16)
    CONV_CASE(ME_FLOAT32, ME_INT32, f32, i32)
    CONV_CASE(ME_FLOAT32, ME_INT64, f32, i64)
    CONV_CASE(ME_FLOAT32, ME_UINT8, f32, u8)
    CONV_CASE(ME_FLOAT32, ME_UINT16, f32, u16)
    CONV_CASE(ME_FLOAT32, ME_UINT32, f32, u32)
    CONV_CASE(ME_FLOAT32, ME_UINT64, f32, u64)
    ...
    CONV_CASE(ME_FLOAT64, ME_INT8, f64, i8)
    CONV_CASE(ME_FLOAT64, ME_INT16, f64, i16)
    CONV_CASE(ME_FLOAT64, ME_INT32, f64, i32)
    CONV_CASE(ME_FLOAT64, ME_INT64, f64, i64)
    CONV_CASE(ME_FLOAT64, ME_UINT8, f64, u8)
    CONV_CASE(ME_FLOAT64, ME_UINT16, f64, u16)
    CONV_CASE(ME_FLOAT64, ME_UINT32, f64, u32)
    CONV_CASE(ME_FLOAT64, ME_UINT64, f64, u64)
    CONV_CASE(ME_FLOAT64, ME_COMPLEX64, f64, c64)
