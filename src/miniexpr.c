...
static void vec_sin_cached(const double* a, double* out, int n) {
    if (!a || !out || n <= 0) {
        return;
    }
...
static void vec_cos_cached(const double* a, double* out, int n) {
    if (!a || !out || n <= 0) {
        return;
    }
    me_sincos_cache_f64 *cache = &me_sincos_cache_dp;
...
static void vec_sin_f32_cached(const float* a, float* out, int n) {
    if (!a || !out || n <= 0) {
        return;
    }
...
static void vec_cos_f32_cached(const float* a, float* out, int n) {
    if (!a || !out || n <= 0) {
        return;
    }
    me_sincos_cache_f32 *cache = &me_sincos_cache_sp;
...
static void vec_sin_dispatch(const double* a, double* out, int n) {
    me_init_simd();
    vec_sin_impl(a, out, n);
}

static void vec_cos_dispatch(const double* a, double* out, int n) {
    me_init_simd();
    vec_cos_impl(a, out, n);
}

static void vec_asin_dispatch(const double* a, double* out, int n) {
    me_init_simd();
    vec_asin_impl(a, out, n);
}

static void vec_acos_dispatch(const double* a, double* out, int n) {
    me_init_simd();
    vec_acos_impl(a, out, n);
}

static void vec_atan_dispatch(const double* a, double* out, int n) {
    me_init_simd();
...
static void vec_atan2_dispatch(const double* a, const double* b, double* out, int n) {
    me_init_simd();
...
static void vec_asin_f32_dispatch(const float* a, float* out, int n) {
    me_init_simd();
    vec_asin_f32_impl(a, out, n);
}

static void vec_acos_f32_dispatch(const float* a, float* out, int n) {
    me_init_simd();
    vec_acos_f32_impl(a, out, n);
}

static void vec_atan_f32_dispatch(const float* a, float* out, int n) {
    me_init_simd();
...
static void vec_atan2_f32_dispatch(const float* a, const float* b, float* out, int n) {
    me_init_simd();
