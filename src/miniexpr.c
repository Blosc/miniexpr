...
static const me_dtype type_promotion_table[13][13] = {
    ...
    {ME_BOOL, ME_INT8,  ME_INT16, ME_INT32, ME_INT64, ME_UINT8,  ME_UINT16, ME_UINT32, ME_UINT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* BOOL */
    {ME_INT8, ME_INT8,  ME_INT16, ME_INT32, ME_INT64, ME_INT16,  ME_INT32,  ME_INT64,  ME_FLOAT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* INT8 */
    {ME_INT16, ME_INT16, ME_INT16, ME_INT32, ME_INT64, ME_INT32,  ME_INT32,  ME_INT64,  ME_FLOAT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* INT16 */
    {ME_INT32, ME_INT32, ME_INT32, ME_INT32, ME_INT64, ME_INT64,  ME_INT64,  ME_INT64,  ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_COMPLEX128, ME_COMPLEX128}, /* INT32 */
    {ME_INT64, ME_INT64, ME_INT64, ME_INT64, ME_INT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_COMPLEX128, ME_COMPLEX128}, /* INT64 */
    {ME_UINT8, ME_INT16, ME_INT32, ME_INT64, ME_FLOAT64, ME_UINT8,  ME_UINT16, ME_UINT32, ME_UINT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* UINT8 */
    {ME_UINT16, ME_INT32, ME_INT32, ME_INT64, ME_FLOAT64, ME_UINT16, ME_UINT16, ME_UINT32, ME_UINT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* UINT16 */
    {ME_UINT32, ME_INT64, ME_INT64, ME_INT64, ME_FLOAT64, ME_UINT32, ME_UINT32, ME_UINT32, ME_UINT64, ME_FLOAT64, ME_FLOAT64, ME_COMPLEX128, ME_COMPLEX128}, /* UINT32 */
    {ME_UINT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_UINT64, ME_UINT64, ME_UINT64, ME_UINT64, ME_FLOAT64, ME_FLOAT64, ME_COMPLEX128, ME_COMPLEX128}, /* UINT64 */
    {ME_FLOAT32, ME_FLOAT32, ME_FLOAT32, ME_FLOAT64, ME_FLOAT64, ME_FLOAT32, ME_FLOAT32, ME_FLOAT64, ME_FLOAT64, ME_FLOAT32, ME_FLOAT64, ME_COMPLEX64, ME_COMPLEX128}, /* FLOAT32 */
    {ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_FLOAT64, ME_COMPLEX128, ME_COMPLEX128}, /* FLOAT64 */
    {ME_COMPLEX64, ME_COMPLEX64, ME_COMPLEX64, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX64, ME_COMPLEX64, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX64, ME_COMPLEX128, ME_COMPLEX64, ME_COMPLEX128}, /* COMPLEX64 */
    {ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128, ME_COMPLEX128}  /* COMPLEX128 */
};
...
void me_free_parameters(me_expr *n) {
    if (!n) return;
    switch (TYPE_MASK(n->type)) {
        case ME_FUNCTION7: case ME_CLOSURE7: 
        ...
        case ME_FUNCTION6: case ME_CLOSURE6:
        ...
        case ME_FUNCTION5: case ME_CLOSURE5:
        ...
        case ME_FUNCTION4: case ME_CLOSURE4:
        ...
        case ME_FUNCTION3: case ME_CLOSURE3:
        ...
        case ME_FUNCTION2: case ME_CLOSURE2:
        ...
        case ME_FUNCTION1: case ME_CLOSURE1:
            ...
            if (isalpha(s->next[0])) {
                ...
                if (!var) {
                    ...
                    switch(TYPE_MASK(var->type))
                    {
                        ...
                        case ME_CLOSURE0: case ME_CLOSURE1: case ME_CLOSURE2: case ME_CLOSURE3:         /* Falls through. */
                        case ME_CLOSURE4: case ME_CLOSURE5: case ME_CLOSURE6: case ME_CLOSURE7:         /* Falls through. */
                            s->context = var->context;                                                  /* Falls through. */

                        case ME_FUNCTION0: case ME_FUNCTION1: case ME_FUNCTION2: case ME_FUNCTION3:     /* Falls through. */
                        case ME_FUNCTION4: case ME_FUNCTION5: case ME_FUNCTION6: case ME_FUNCTION7:     /* Falls through. */
                            s->type = var->type;
                ...
                if (c == '*' && next_c == '*') {
                    s->type = TOK_POW; s->function = (const void *)pow; s->next += 2;
                } else if (c == '<' && next_c == '<') {
                    s->type = TOK_SHIFT; s->function = bit_shl; s->next += 2;
                } else if (c == '>' && next_c == '>') {
                    s->type = TOK_SHIFT; s->function = bit_shr; s->next += 2;
                } else if (c == '=' && next_c == '=') {
                    s->type = TOK_COMPARE; s->function = cmp_eq; s->next += 2;
                } else if (c == '!' && next_c == '=') {
                    s->type = TOK_COMPARE; s->function = cmp_ne; s->next += 2;
                } else if (c == '<' && next_c == '=') {
                    s->type = TOK_COMPARE; s->function = cmp_le; s->next += 2;
                } else if (c == '>' && next_c == '=') {
                    s->type = TOK_COMPARE; s->function = cmp_ge; s->next += 2;
                } else {
                    ...
                    switch (c) {
                        ...
                        case '^': s->type = TOK_BITWISE; s->function = bit_xor; break;  /* XOR for ints/bools */
...
static me_expr *base(state *s) {
    ...
    switch (TYPE_MASK(s->type)) {
        ...
        case ME_FUNCTION2: case ME_FUNCTION3: case ME_FUNCTION4:
        case ME_FUNCTION5: case ME_FUNCTION6: case ME_FUNCTION7:
        case ME_CLOSURE2: case ME_CLOSURE3: case ME_CLOSURE4:
        case ME_CLOSURE5: case ME_CLOSURE6: case ME_CLOSURE7:
            arity = ARITY(s->type);
    ...
    switch(TYPE_MASK(n->type)) {
        ...
        case ME_FUNCTION4: case ME_FUNCTION5: case ME_FUNCTION6: case ME_FUNCTION7:
            switch(ARITY(n->type)) {
                ...
                case 6: return ME_FUN(double, double, double, double, double, double)(M(0), M(1), M(2), M(3), M(4), M(5));
                case 7: return ME_FUN(double, double, double, double, double, double, double)(M(0), M(1), M(2), M(3), M(4), M(5), M(6));
                default: return NAN;
            }
        ...
        case ME_CLOSURE4: case ME_CLOSURE5: case ME_CLOSURE6: case ME_CLOSURE7:
            switch(ARITY(n->type)) {
                ...
                case 5: return ME_FUN(void*, double, double, double, double, double)(n->parameters[5], M(0), M(1), M(2), M(3), M(4));
                case 6: return ME_FUN(void*, double, double, double, double, double, double)(n->parameters[6], M(0), M(1), M(2), M(3), M(4), M(5));
                case 7: return ME_FUN(void*, double, double, double, double, double, double, double)(n->parameters[7], M(0), M(1), M(2), M(3), M(4), M(5), M(6));
                default: return NAN;
            }
...
void me_eval(const me_expr *n) {
    ...
    if (result_type == n->dtype && all_match) {
        ...
        switch(n->dtype) {
            case ME_BOOL: me_eval_i8(n); break;
            case ME_INT8: me_eval_i8(n); break;
            case ME_INT16: me_eval_i16(n); break;
            case ME_INT32: me_eval_i32(n); break;
            case ME_INT64: me_eval_i64(n); break;
            case ME_UINT8: me_eval_u8(n); break;
            case ME_UINT16: me_eval_u16(n); break;
            case ME_UINT32: me_eval_u32(n); break;
            case ME_UINT64: me_eval_u64(n); break;
            case ME_FLOAT32: me_eval_f32(n); break;
            case ME_FLOAT64: me_eval_f64(n); break;
            case ME_COMPLEX64: me_eval_c64(n); break;
            case ME_COMPLEX128: me_eval_c128(n); break;
        }
        return;
    }
