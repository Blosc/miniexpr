/* Generated by scripts/gen_unicode_case.py -- do not edit by hand. */
/* Unicode 15.0.0, Python 3.12 */

#ifndef MINIEXPR_UNICODE_CASE_TABLE_H
#define MINIEXPR_UNICODE_CASE_TABLE_H

#include <stdint.h>

#define ME_CASE_MAX_EXPANSION 3

typedef struct { uint32_t from; uint32_t to; } me_case_pair;
typedef struct { uint32_t from; uint8_t len; uint32_t to[ME_CASE_MAX_EXPANSION]; } me_case_expansion;

static const me_case_pair me_case_lower_simple[] = {
    {0x0041, 0x0061},
    {0x0042, 0x0062},
    {0x0043, 0x0063},
    {0x0044, 0x0064},
...
#define ME_CASE_LOWER_SIMPLE_COUNT ((int)(sizeof(me_case_lower_simple) / sizeof(me_case_lower_simple[0])))

static const me_case_pair me_case_upper_simple[] = {
    {0x0061, 0x0041},
    {0x0062, 0x0042},
    {0x0063, 0x0043},
    {0x0064, 0x0044},
...
#define ME_CASE_UPPER_SIMPLE_COUNT ((int)(sizeof(me_case_upper_simple) / sizeof(me_case_upper_simple[0])))

static const me_case_expansion me_case_lower_expand[] = {
    {0x0130, 2, {0x0069, 0x0307, 0x0000}},
};
#define ME_CASE_LOWER_EXPAND_COUNT ((int)(sizeof(me_case_lower_expand) / sizeof(me_case_lower_expand[0])))

static const me_case_expansion me_case_upper_expand[] = {
...
#define ME_CASE_UPPER_EXPAND_COUNT ((int)(sizeof(me_case_upper_expand) / sizeof(me_case_upper_expand[0])))

#endif /* MINIEXPR_UNICODE_CASE_TABLE_H */
